...
import AuthCode from "@/components/auth-code/auth-code";
import { AuthCodeRef } from "@/components/auth-code/auth-code.types";

import { TimerRef } from "@/components/timer/timer.types";
